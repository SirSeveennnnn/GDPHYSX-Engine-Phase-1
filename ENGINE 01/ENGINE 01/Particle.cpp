...
void Particle::integrate(float deltaTime)
{
	...
	glm::vec3 resultingAcceleration;
	resultingAcceleration = acceleration * (1 /inverseMass); //inverse mass is 1 / mass meaning 1/(1/mass)

	//update velocity with acceleration, should be deltaTime* deltaTime but it doesnt feel right
	velocity += resultingAcceleration * deltaTime * 0.5f;
...
void Particle::FireArtillery()
{
    ...
    SetVelocity(glm::vec3(70, 60.f, -35.f));
...
void Particle::FireFireball()
{
    ...
    SetVelocity(glm::vec3(30, 0.f, -10.f));
    SetAcceleration(glm::vec3(0, 10.f, 0));
    SetInverseMass(1);
    SetDamping(0.999f);
    SetLifeTime(7.f);
